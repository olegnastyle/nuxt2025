<template>
    ...
    <ul class="my-4 text-black dark:text-white">
        <li>Номер: <a class="underline hover:text-cyan-500" href="tel:79933079829">+7 (993) 307-98-29</a></li>
        <li>Почта: <a class="underline hover:text-cyan-500" href="mailto:oleg@nastyle.pro">oleg@nastyle.pro</a></li>
    </ul>
