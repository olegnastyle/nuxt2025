  ...
  <div class="flex flex-col">
    ...
    <section class="bg-white dark:bg-gray-900"
      ...
      <div
        ...
        <div class="mt-4 md:mt-0">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">У нас собрано много
            инструментов для разработчиков.</h2>
          <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">В нашем блоге вы найдете инструменты
            для разработчиков: ресурсы, курсы и статьи по веб-разработке. Мы предлагаем актуальные материалы и советы
            для вашего самообразования и развития навыков.</p>
          <a href="#"
    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16"
      ...
      <div
        ...
        <a href="#" class="flex items-center md:justify-center">
          <svg class="h-8 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 210 33" fill="currentColor"
            xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="#">
          <svg class="h-8 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 568 286" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="306" width="262" height="39" fill="white"/>
          <rect x="529" width="39" height="243" fill="white"/>
          <path d="M25.5 62.5H65.5V97.5H102V130.5H65.5V176C66 187 75.4 204.7 109 187.5L123 215.5C93.1667 232.333 31.9 248 25.5 176V130.5H0V97.5H25.5V62.5Z" fill="white"/>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M204.5 95.5C229.333 95.5 279 109.9 279 167.5C279 176 267.5 231 204.5 231C141.5 231 130.5 178 130.5 167.5C130.5 157 136.5 95.5 204.5 95.5ZM235.5 167.5C235.5 133.9 214.833 126.833 204.5 127.5C173.5 127.5 174 157 174 167.5C174 178 182.5 198 204.5 198C226.5 198 231 183.5 235.5 167.5Z" fill="white"/>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M294 98.5H358.5V122.5C366.667 112.833 390 93.5 418 93.5C453 93.5 470 139 470 164.5C470 190 438.5 258 358.5 217V253.5H383.5V286H294V253.5H319V131.5H294V98.5ZM358.5 185.5V154C416 97.5 424.5 154 424.5 164.5C420.1 205.7 378.667 195.667 358.5 185.5Z" fill="white"/>
          </svg>
        </a>
      </div>
    </section>
